Ok I want you to create a file just make it the same as I’m about to paste but just add it’s like a discord bot save everything but all I want you to const{Client,GatewayIntentBits,PermissionFlagsBits,EmbedBuilder,ActionRowBuilder,ButtonBuilder,ButtonStyle,ChannelType,ModalBuilder,TextInputBuilder,TextInputStyle}=require('discord.js');
