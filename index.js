...
// ══════════════════════════════════════════════════════════════════════════════
// CLAUDE AI HELPER
// Calls the Anthropic API and returns the assistant's reply text.
// Requires ANTHROPIC_API_KEY in your environment variables.
// ══════════════════════════════════════════════════════════════════════════════
async function askClaude(channelId, userMessage) {
  ...
  const response = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 1024,
      system: 'You are a helpful AI assistant inside a Discord server. Be friendly, concise, and helpful. Format responses in a way that reads well in Discord (use **bold**, bullet points, and code blocks where appropriate).',
      messages: history,
    }),
  });
